...
function Recommend() {
  ...
  const [flipCardId, setFlipCardId] = useState(null);
  ...
  const handleCardClick = (id) => {
    // If the clicked card is already flipped, set flipCardId to null; otherwise, set it to the clicked card's ID
    setFlipCardId(flipCardId === id ? null : id);
  };
    ...
    <div className="container mt-5">
      ...
      <div className="row">
        ...
        {recommendations.map((rec) => (
          <div className="col-md-4 mb-4" key={rec.id} onClick={() => handleCardClick(rec.id)}>
